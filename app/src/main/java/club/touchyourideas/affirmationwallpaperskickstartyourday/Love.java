...
public class Love extends AppCompatActivity {
    ...
    Integer[] imageArray = {
            R.drawable.love_affirmation, R.drawable.love_affirmation2,
            R.drawable.love_affirmation3,R.drawable.love_affirmation4,
            R.drawable.love_affirmation5,R.drawable.love_affirmation6,
            R.drawable.love_affirmation7,R.drawable.love_affirmation8
    };
