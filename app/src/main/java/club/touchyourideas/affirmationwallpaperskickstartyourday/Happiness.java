...
public class Happiness extends AppCompatActivity {
    ...
    Integer[] imageArray = {
            R.drawable.happiness_affirmation, R.drawable.happiness_affirmation2,
            R.drawable.happiness_affirmation3,R.drawable.happiness_affirmation4,
            R.drawable.happiness_affirmation5,R.drawable.happiness_affirmation6,
            R.drawable.happiness_affirmation7,R.drawable.happiness_affirmation8
    };
