...
public class Attracting extends AppCompatActivity {

    Integer[] imageArray = {
            R.drawable.magnet_affirmation, R.drawable.magnet_affirmation2,
            R.drawable.magnet_affirmation3,R.drawable.magnet_affirmation4,
            R.drawable.magnet_affirmation5,R.drawable.magnet_affirmation6,
            R.drawable.magnet_affirmation7,R.drawable.magnet_affirmation8
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attracting);
